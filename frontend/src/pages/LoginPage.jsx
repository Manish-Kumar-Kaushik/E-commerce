...
const LoginPage = () => {
  ...
  const isVerifying = window.location.search.includes('verify_email')
  const redirectUrl = searchParams.get('redirect') || '/'
  const signUpUrl = `/account/register?redirect=${encodeURIComponent(redirectUrl)}`
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-violet-50 via-purple-50 to-fuchsia-50 flex items-center justify-center p-8">
      <Seo title="Login" description="Sign in to your Shopzy account." />
